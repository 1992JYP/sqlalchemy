...
from typing import Callable, List, OrderedDict, TypeVar
from typing_extensions import ParamSpec

from core.config import Settings, settings
from common.logging import get_rotate_logger
from db.session import Session, SessionLocal, sessionmaker
# from egkafka import producer
## typing
_P = ParamSpec("_P")
_R = TypeVar("_R")
...
# dependency['log'] = get_rotate_logger(
#     settings.get_logger_name(),
#     settings.get_logging_level(),
#     settings.get_rt_log_file_name(),
...
# dependency['base_producer'] = producer.base_producer
## 의존성 객체 생성 종료


def inject(f: Callable[_P, _R]) -> Callable[_P, _R]:
    """매개변수로 전달받은 함수의 Signiture 확인 후 미리 정의된
    di 사전에 존재하는 의존성 주입.
    https://www.programcreek.com/python/example/102559/inspect.Signature 참조
